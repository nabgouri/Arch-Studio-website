...
const HeroHomeSection = () => {
  ...
  const backgroundImages = [
    ...
    "src/assets/images/homeImages/carousel images/secondlyImage.png",
    "src/assets/images/homeImages/carousel images/thirdlyImage.png",
    "src/assets/images/homeImages/carousel images/fourthImage.png",
  ];
