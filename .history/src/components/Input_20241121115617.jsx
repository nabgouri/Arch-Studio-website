  ...
  if (type === "message") {
    ...
    return (
      <div className="flex">
        <input
          className={twMerge(
            "mb-11 w-full relative border-b-[1px] border-[#1B1D23] pb-5 pl-[2.125rem] placeholder:text-[1.25rem] placeholder:font-bold placeholder:text-[#c8ccd8] focus:border-b-4 focus:border-b-[#1b1d23] focus:placeholder:text-[#1b1d23] focus-visible:outline-none",
            errorCLass,
          )}
          type={type}
        ...
        <span
          className={
            emptydata
              ? "absolute top-0 text-lg font-bold text-[#df5656]"
              : "hidden"
          }
        >
          Can&apos;t be empty
