...
const HeroHomeSection = () => {
  ...
  return (
    <>
      <section className="block bg-[rgba(0,0,0,0.35)] bg-[url('src/assets/images/homeImages/mainHomeImage.png')] bg-cover bg-no-repeat px-8 pb-[6.875rem] pt-[7.25rem] bg-blend-overlay md:mx-24 md:px-[3.625rem] xl:mx-[10.25rem] xl:hidden xl:px-[11.875rem] xl:pe-[23.75rem] xl:pt-[11.625rem]">
