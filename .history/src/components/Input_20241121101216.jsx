  ...
  if (type === "message") {
    ...
    return (
      <input
        ...
        placeholder={label}
      />
      <span className={emptydata? 'relative after:content-['Cant be empty'] after:absolute after:left-0 after:top-full after:text-[#df5656] after:text-sm '}>Can't be empty</span>
