        ...
        <div className="absolute bottom-0 left-[5.25rem] flex">
          {backgroundImages.map((_, index) => (
            <button
              ...
              className={`hidden h-20 w-20 items-center justify-center md:flex ${currentImageIndex === index ? "bg-[#1b1d23] text-lg font-bold leading-6 text-white" : "bg-white text-[#7D828F] hover:bg-[#EEEFF4]"}`}
            >
