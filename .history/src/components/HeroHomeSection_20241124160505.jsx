        ...
        <div className="absolute bottom-8 left-8 flex space-x-4">
          {backgroundImages.map((_, index) => (
            <button
              ...
              className={`flex h-20 w-20 items-center justify-center border border-white text-white ${currentImageIndex === index ? "bg-[#1b1d23] text-lg font-bold leading-6 text-white" : "hover:bg-white/20"}`}
            >
