...
export default function HomePage() {
  return (
    <main className="relative md:before:absolute md:before:left-5 md:before:top-5 md:before:block md:before:rotate-90 md:before:text-lg md:before:font-medium md:before:leading-6 md:before:tracking-[18px] md:before:text-[#c8ccd8] md:before:content-['HOME']">
