...
export default function HomePage() {
  return (
    <main className="relative md:text-lg md:leading-[1.125rem] md:before:absolute md:before:left-4 md:before:top-0 md:before:block md:before:w-[0.125rem] md:before:bg-[#c8ccd8] md:before:font-medium md:before:content-['HOME']">
