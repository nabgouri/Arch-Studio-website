...
export default function HomePage() {
  return (
    <main className="relative md:before:absolute md:before:left-4 md:before:top-0 md:before:block md:before:h-[6.5rem] md:before:w-[0.125rem] md:before:bg-[#c8ccd8] md:before:content-['HOME']">
